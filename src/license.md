...
[realtime-vehicle-tracking.github.io](https://realtime-vehicle-tracking.github.io)
...
Map data &copy; [OpenStreetMap](https://www.openstreetmap.org/copyright) contributors, available under the [Open Database License](https://opendatacommons.org/licenses/odbl/).

Regional OSM data files sourced from [Geofabrik](https://download.geofabrik.de/).
